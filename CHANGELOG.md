...
* 29.06.2022 Михаил Краснов <linuxoid85@gmail.com>
    - Переписывание `logo` с Python на C++;
    - Переписывание `ver` с Python на C++;

* 25.06.2022 Михаил Краснов <linuxoid85@gmail.com>
    - Добавление скрипта для получения сведений о системе.

* 13.06.2022 Михаил Краснов <linuxoid85@gmail.com>
    - Добавление файла с философией дистрибутива;
    - Изменение прав доступа к `./src/std-checker/checker.py`.

* 12.06.2022 Михаил Краснов <linuxoid85@gmail.com>
    - Добавление скрипта для проверки системы на совместимость с FHS;
    - Добавление дополнительной документации (стандарты FHS, LSB).

* 09.06.2022 Михаил Краснов <linuxoid85@gmail.com>
    - Добавление информации о разработчиках;
    - Удаление устаревшего исходного кода;
    - Удаление устаревшей документации;
    - Замена `distro.json` на `distro.toml`.
